...
type LinkId = "home" | "explore" | "messages" | "profile";
...
const Animation = () =>  {
    ...
    const updateStyles = (id: LinkId) => {
        const border = document.querySelector(".border-effect") as HTMLElement;
        document.getElementById("home-icon") as HTMLElement;
        document.getElementById("explore-icon") as HTMLElement;
        document.getElementById("messages-icon") as HTMLElement;
        document.getElementById("profile-icon") as HTMLElement;
